            ...
            <div className="mx-auto max-w-[1440px] px-6 lg:px-12">
                ...
                >
                    ...
                    <div className="relative z-10 lg:col-span-7">
                        ...
                        {/* Animated Heading */}
                        <h2 className="font-heading font-semibold text-4xl md:text-5xl lg:text-[4.5rem] leading-[0.95] tracking-[-0.03em] mb-6 text-blue flex flex-col overflow-hidden">
                    ...
                    {/* Right Column - Static Project Image */}
