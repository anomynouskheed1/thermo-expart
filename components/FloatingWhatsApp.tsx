    ...
    return (
        <aside aria-label="Support and Communication" className="fixed bottom-6 right-6 z-50 flex items-center justify-center">
            ...
            >
                ...
                <span className="absolute right-full mr-3 px-3 py-1.5 bg-[#151c24] text-white text-[11px] font-mono tracking-wider uppercase border border-white/15 opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap pointer-events-none">
                    Chat on WhatsApp
                </span>
            </motion.a>
        </aside>
